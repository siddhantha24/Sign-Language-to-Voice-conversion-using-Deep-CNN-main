...
L1 = Label(f1, bg="white", height="300", width="500")
...
amountentry = Entry(root, text="submit!", fg = 'black', bg='white', textvariable=amountVal, width=30, borderwidth=3, relief="ridge")
amountentry.grid(row=3,column=0, padx=100, pady=10)
btn = Button(root,text="submit", command=getvals, font=("comicsansms", 10, "bold"), relief=GROOVE ).grid(row=4,column=0, pady = 10, padx = 100)
btn = Button(text="Via which Station", command=getvals1, font=("comicsansms", 10, "bold"), relief=GROOVE ).grid(row=5,column=0,pady = 10, padx = 100)

btn = Button(root, text= "Speak", command=speak, font=("comicsansms", 10, "bold"), relief=GROOVE ).grid(row=6,column=0, pady =10,padx=100)
#----------------------------------------#
#project wala opencv
